...
# REFINAMENTO: Proteção de escopo para testes automatizados (CI/CD).
# ==============================================================================
...
def validate_data_quality(df, context="PRODUCAO"):
    ...
    if not df_quarantine.empty:
        ...
        # Só tenta salvar no S3 se não estivermos em ambiente de teste
...
# --- BLOCO DE EXECUÇÃO (PROTEÇÃO CONTRA IMPORT) ---
